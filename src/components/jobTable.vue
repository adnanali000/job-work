      ...
      <div class="w-full mt-4">
        ...
        >
          ...
          <tbody>
            ...
            >
              <td class="text-green-600 border border-slate-300 p-2 ...">{{ data.jobType || "null" }}</td>
              <td class="text-red-600 border border-slate-300 p-2 ...">{{ data.marketId || "null"}}</td>
              <!-- <td class="text-green-600 text-gray-500 border border-slate-300 p-2 ...">{{ data.occurrence || "null" }}</td> -->
              <td class="text-green-600 text-gray-500 border border-slate-300 p-2 ...">{{ displayOccurrence(data) }}</td>
              ...
              <td class="border border-slate-300 p-2 ...">
                <div class="flex flex-column justify-center items-center">
                  <button
                    ...
                    class="button border border-solid bg-red-200 ml-2 hover:bg-red-500 hover:text-white px-4 py-2 my-2"
                  >
                    Delete
                  </button>
                </div>
  ...
  export default {
    ...
    methods: {
      displayOccurrence(val){
          ...
          if(val.occurrence === "W"){
            return curobj ? curobj.desc + " on " + day.desc : ''
          }
          if(val.occurrence === "D"){
