<template>
  <div>
    ...
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      <span class="ml-3 text-xl">Office Job</span>
    </a>
    
    <nav class="md:ml-auto flex flex-wrap cursor-pointer items-center text-base justify-center">
      <a @click="goToHome" class="mr-5 hover:text-gray-900">Create Job</a>
      <a @click="goToJobs" class="mr-5 hover:text-gray-900">All Jobs</a>
    </nav>
